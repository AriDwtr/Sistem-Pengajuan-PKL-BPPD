            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{ Route('admin.foto') }}" class="btn btn-primary px-4"><i
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-body">
                                <form class="row g-3" action="{{ Route('detail.update', Auth::user()->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    @foreach ($detail as $data)
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" value="{{ $instansi->nama_instansi }}"
                                                class="form-control @error('tmpt') is-invalid @enderror"
                                                id="validationCustom03" placeholder="Tempat Lahir" readonly>
                                            @error('tmpt')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            @endforeach
